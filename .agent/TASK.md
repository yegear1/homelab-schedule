...
- **Título:** Nenhuma
- **Status:** `CONCLUÍDO`
- **Contexto:** `[99.1]` publicou `v0.2.0` (tag Git + GitHub Release). Numeração reiniciada após a tag. Próximo épico (contatos/modelos) só com aprovação.
...
(Vazio — ciclo atual após `v0.2.0`.)

---

## Backlog (Próximas, em ordem)

(Vazio — aguardando definição do épico de contatos/modelos ou outra prioridade.)
